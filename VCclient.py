    ...
    try:
        ...
        while True:
            ...
            select_mode = input('Please enter a number from 0 to 4\n' + \
                                '0 : Compress your video file\n' + \
                                '1 : Change the resolution of your video\n' + \
                                '2 : Change the aspect ratio of your video\n' + \
                                '3 : Change your video to audio\n' + \
                                '4 : Produce GIFs from time range specified by you\n')
